...
find_path(LIBNET_INCLUDE_DIRS NAMES libnet.h PATH_SUFFIXES libnet11)
mark_as_advanced(LIBNET_INCLUDE_DIRS)
...
if(LIBNET_FIND_VERSION)
  ...
  _libnet_get_version(LIBNET_VERSION LIBNET_VERSION_MAJOR LIBNET_VERSION_MINOR ${LIBNET_INCLUDE_DIRS}/libnet.h)
...
find_package_handle_standard_args(LIBNET DEFAULT_MSG LIBNET_LIBRARY LIBNET_INCLUDE_DIRS)

if(LIBNET_FOUND)
  set(LIBNET_FOUND ${LIBNET_FOUND})
  set(LIBNET_LIBRARY ${LIBNET_LIBRARY})
  set(LIBNET_INCLUDE_DIRS ${LIBNET_INCLUDE_DIRS})
